<div align="center">
  ...
  <h2 align="center">Kabth Market Pro Price Tracking Application</h2>
</div>
...
Developed using Next.js and Bright Data's webunlocker, this e-commerce product scraping site is designed to assist users in making informed decisions. It notifies users via email when a product drops in price and helps competitors by alerting them when the product is out of stock, all managed through cron jobs.
...
```bash
git clone https://github.com/Kalebtes2031/MarketPlacePro.git
cd marketplacepro
```
